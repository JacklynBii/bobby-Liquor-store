...
{   JFrame jf;
	...
	public MainMenu()
	{
		...
		l1=new JLabel("WELCOME TO BOBBY LIQOUR MANAGEMENT SYSTEM");
		...
		m2=new JMenu("Liqour");
		mbar.add(m2);
		m2_1 = new JMenuItem("Add New liqour",new ImageIcon("images//addnew.png"));
		m2.add(m2_1);
		m2_2 = new JMenuItem("search liqour",new ImageIcon("images//search.png"));
		m2.add(m2_2);
		m2_3 = new JMenuItem("Update liqour",new ImageIcon("images//update.png"));
		m2.add(m2_3);
		m2_4 = new JMenuItem("Delete liqour",new ImageIcon("images//delete.png"));
		m2.add(m2_4);
	    m2_5 = new JMenuItem("Liqour Stock",new ImageIcon("images//all.png"));
		m2.add(m2_5);
		...
		m3_2 = new JMenuItem("Suplier liqour Report",new ImageIcon("images//report.png"));
		m3.add(m3_2);
