...
public class Updateliqour extends JFrame implements ActionListener
{
	JFrame jf;
	...
	UpdateLiquor()
	{
	    ...
	    ln=new JLabel("Update Liqour");
	    ln.setFont(new Font("Times New Roman",Font.BOLD,25));
	    ln.setForeground(Color.blue);
	    ln.setBounds(300,30,300,40);
	    jf.add(ln);

		l1 = new JLabel("Liqour Batch no*");
		//l1.setFont(f);
  l1.setBounds(50,100,200,25);
		jf.add(l1);

		t1 = new JTextField(20);
		t1.setBounds(250,100,100,25);t1.setToolTipText("Enter liqour batch no");
		jf.add(t1);

		l2 = new JLabel("liqour name*");
		//l2.setFont(f);
   l2.setBounds(50,140,200,25);
		jf.add(l2);

    	t2 = new JTextField(20);
		t2.setBounds(250,140,200,25);t2.setToolTipText("Enter liqour name");
		jf.add(t2);

		l3 = new JLabel("Liqour manufacturer*");
		//l3.setFont(f);
  l3.setBounds(50,180,200,25);
		jf.add(l3);

     	t3 = new JTextField(20);
		t3.setBounds(250,180,200,25);t3.setToolTipText("Enterliqour manufacturer");
		jf.add(t3);

		l4 = new JLabel("liqour quantity*");
		//l4.setFont(f);
  l4.setBounds(50,220,200,25);
    	jf.add(l4);

        t4= new JTextField(20);
		t4.setBounds(250,220,100,25);t4.setToolTipText("Enter liqour quantity");
		jf.add(t4);

		l5= new JLabel("liqour expiry date*");
		//l5.setFont(f);
  l5.setBounds(50,260,250,25);
		jf.add(l5);

	    t5= new JTextField(20);
		t5.setBounds(250,260,100,25);t5.setToolTipText("Enter liqour expiry date");
		jf.add(t5);

	    l6= new JLabel("liqour purchase date*");
		//l6.setFont(f);
  l6.setBounds(50,300,260,25);
    	jf.add(l6);

        t6= new JTextField(20);
		t6.setBounds(250,300,100,25);t6.setToolTipText("Enter liqour expiry date");
		jf.add(t6);

		l7 = new JLabel("liqour type*");
		//l7.setFont(f);
  l7.setBounds(470,100,200,25);
		...
		tabtype.addItem("Whyskey");
		tabtype.addItem("beer");
		tabtype.addItem("Vodka");
		tabtype.addItem("Wine");
		tabtype.addItem("spirit");
		tabtype.addItem("soda");
	
		tabtype.setBounds(600,100,100,25);tabtype.setToolTipText("Select liqour type");
		jf.add(tabtype);
		...
		l8= new JLabel("liqour purchase price*");
		//l8.setFont(f);
 l8.setBounds(470,140,220,25);
    	jf.add(l8);

        t8 = new JTextField(20);
		t8.setBounds(720,140,100,25);t8.setToolTipText("Enter liqour purchase price");
		jf.add(t8);

		l9 = new JLabel("liqour sale price*");
	//	l9.setFont(f);
  l9.setBounds(470,180,200,25);
    	jf.add(l9);

        t9 = new JTextField(20);
		t9.setBounds(720,180,100,25);t9.setToolTipText("Enter liqour sale price");
		jf.add(t9);

		l10 = new JLabel("liquor rack no*");
		//l10.setFont(f);
l10.setBounds(470,220,200,25);
    	jf.add(l10);

        t10 = new JTextField(20);
		t10.setBounds(720,220,100,25);t10.setToolTipText("Enter liqour rack no");
		jf.add(t10);
 ...
 l12.setBounds(470,300,180,25);
        ...
        try
		{
		    ...
		    con=DriverManager.getConnection("jdbc:mysql://localhost:3306/liqour_store","root","");
       ...
       System.out.println(e);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to open liqour details");
		jf.add(b0);b0.addActionListener(this);

		b1 = new JButton("Update",new ImageIcon("images//update.png"));
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to update liqour details");
		...
		b3.setBounds(600,330,110,35);b3.setToolTipText("click to view all liqour details");
 ...
 public void actionPerformed(ActionEvent ae)
  {
  	if(ae.getSource()==b0)
	  {
	        ...
	        {
		    JOptionPane.showMessageDialog(this,"Please enter Liqour batchno or name !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
		...
		System.out.println("Connected to database.");
		  ...
		  ps=con.prepareStatement("select * from Liqour where lname='"+t2.getText()+"' or lbno='"+t1.getText()+"' ");
		  rs=ps.executeQuery();
		  while(rs.next())
	      {
	       ...
	       if (foundrec == 0)
                {
                    JOptionPane.showMessageDialog(null,"Record not available","Dialogs",JOptionPane.WARNING_MESSAGE);
                }
	   ...
	   try
	    {
	        ...
	        {
		    JOptionPane.showMessageDialog(this,"*  Missing details !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
			Class.forName("com.mysql.jdbc.Driver");
...
String str1="UPDATE Liqour SETlbno='"+t1.getText()+"',lname='"+t2.getText()+"',lompany='"+t3.getText()+"',lqty='"+t4.getText()+"',lexpdate='"+t5.getText()+"',lpurdate='"+t6.getText()+"',ltype='"+t7.getText()+"',lpurprice='"+t8.getText()+"',lsaleprice='"+t9.getText()+"',lrackno='"+t10.getText()+"',sid='"+t12.getText()+"',sname='"+t11.getText()+"' where mbno='"+t1.getText()+"'or mname='"+t2.getText()+"'";
