...
public class SearchLiqour extends JFrame implements ActionListener
{
	JFrame jf;
  ...
  l1.setBounds(50,100,200,25);
		...
		t1.setBounds(250,100,100,25);t1.setToolTipText("Enter Liqour batch no to search");
		jf.add(t1);
   ...
   l2.setBounds(50,140,200,25);
		...
		t2.setBounds(250,140,200,25);t2.setToolTipText("Enter liqour name to search");
		jf.add(t2);

		l3 = new JLabel("liqour manufacturery");
		//l3.setFont(f);
   ...
   l4.setBounds(50,220,200,25);
		...
		l5= new JLabel("liquor expiry date");
		//l5.setFont(f);
   ...
   l11.setBounds(470,260,180,25);
 	...
 	l12.setBounds(470,300,180,25);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to search liqour details");
	 ...
	 {//fetch
		...
		System.out.println("Connected to database.");
		  ...
		  while(rs.next())
	      {
	        ...
	        if (foundrec == 0)
                {
                    JOptionPane.showMessageDialog(null,"Record  not available","Dialog",JOptionPane.WARNING_MESSAGE);
                }
	         }
	         con.close();
        }
  ...
  {//list
     ...
     try
     {
        ...
        rs = stmt.executeQuery("SELECT * from Liqour" );
          while(rs.next())
            {
