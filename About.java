...
class About extends JFrame
{
	...
	About()
	{
		...
		l1 = new JLabel("Bobby Liquor Management System");
		...
		l3 = new JLabel("Miss Jacklyn Bii (Krolyn Enterprises.");
		l3.setFont(new Font("Times New Roman",Font.BOLD,18));
		l3.setBounds(300,200,400,40);l3.setForeground(Color.red);
		jf.add(l3);

		l4 = new JLabel("Under the guidance of bobby Management.");
		l4.setFont(new Font("Times New Roman",Font.BOLD,18));l4.setForeground(Color.red);
		l4.setBounds(100,250,800,40);
		jf.add(l4);

		l5 = new JLabel("In this system we can add details of Liqour,Suppliers.");
		...
		l7 = new JLabel("It is helpful for stock keeping in Liqour stores & where liqour placed the liqour in store.");
