...
public class AddNewMedicine extends JFrame implements ActionListener
{
	...
	AddNewMedicine()
	{
	    ...
	    ln=new JLabel("New Liquor details");
    ...
    l1.setBounds(50,100,200,25);
		...
		t1.setBounds(250,100,100,25);t1.setToolTipText("Enter liquor batch no");
		jf.add(t1);
    ...
    l2.setBounds(50,140,200,25);
		...
		t2.setBounds(250,140,200,25);t2.setToolTipText("Enter liquor name");
		jf.add(t2);
    ...
    l3.setBounds(50,180,200,25);
		...
		t3.setBounds(250,180,200,25);t3.setToolTipText("Enter liqour manufacturer");
		jf.add(t3);
   ...
   l4.setBounds(50,220,200,25);
    ...
    l5.setBounds(50,260,250,25);
		...
		t5.setBounds(250,260,100,25);t5.setToolTipText("Enter liquor expiry date");
		jf.add(t5);

		l6= new JLabel("liquor purchase date*");
		//l6.setFont(f);
   ...
   l7.setBounds(470,100,200,25);
		...
		tabtype.setBounds(720,100,100,25);tabtype.setToolTipText("Select liquor type");
		jf.add(tabtype);
  ...
  l10.setBounds(470,220,200,25);
    ...
    l11.setBounds(470,260,250,25);
        ...
        msname.setBounds(720,260,130,25);msname.setToolTipText("select liqour supplier name");
        jf.add(msname);
       ...
       System.out.println(e);
        ...
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to save liqour details");
		...
		b2.setBounds(450,330,110,35);b2.setToolTipText("click to view all liqour details");
 ...
 ps=con.prepareStatement("insert into Liqour (lbno,lname,lcompany,lqty,lexpdate,lpurdate,ltype,lpurprice,lsaleprice,lrackno,sid,sname)values(?,?,?,?,?,?,?,?,?,?,?,?)");
  ...
  int reply=JOptionPane.showConfirmDialog(null,"Records added successfully.Do you want add more ?","Added liqour",JOptionPane.YES_NO_OPTION);
